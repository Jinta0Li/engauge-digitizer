...
<context>
    ...
    <message>
        ...
        <translation>已创建清单指南。</translation>
    </message>
    <message>
        ...
        <translation>为什么导入的图像看起来不同？</translation>
    </message>
    <message>
        ...
        <translation>导入后，过滤后的图像将显示在背景中。根据在“设置/滤色器”中设置的参数，从原始图像生成此滤波图像。正确设置参数后，已从过滤后的图像中删除了不重要的信息（如网格线和背景颜色），因此可以执行自动特征提取。如果已从图像中删除了所需的功能，则可以使用“设置/滤色器”调整参数，或者可以使用“视图/背景/显示原始图像”显示原始图像。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>只要图像具有用于定义坐标的轴和/或网格线，Engauge就会将图形或地图的图像转换为数字。</translation>
    </message>
    <message>
        ...
        <translation>该向导会创建一个步骤清单，可作为有用的指南。通过执行这些步骤，您可以在导出的文件中获取数字化数据点。该向导还提供了Engauge最有用功能的快速摘要。</translation>
    </message>
    <message>
        ...
        <translation>可以使用“帮助”菜单打开和关闭该向导。</translation>
    </message>
    <message>
        ...
        <translation>建议新用户使用此向导。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        <location filename="../src/Create/CreateMenus.cpp" line="30"/>
        <source>Open &amp;Recent</source>
        <translation>打开最近的文件</translation>
    </message>
    <message>
        <location filename="../src/Create/CreateMenus.cpp" line="46"/>
        <source>&amp;Edit</source>
...
The expected format of the coordinate value is determined by the locale setting. If typed values are not recognized as expected, check the locale setting in Settings / Main Window...</source>
        <translation>输入轴点的第一个图形坐标。对于笛卡尔图，这是X.对于极坐标图，这是角度θ。坐标值的预期格式由区域设置确定。如果未按预期识别键入的值，请检查“设置/主窗口”中的区域设置...</translation>
    </message>
    <message>
...
The expected format of the coordinate value is determined by the locale setting. If typed values are not recognized as expected, check the locale setting in Settings / Main Window...</source>
        <translation>输入轴点的第二个图形坐标。对于笛卡尔图，这是Y.对于极坐标图，这是半径R.坐标值的预期格式由区域设置决定。如果未按预期识别键入的值，请检查“设置/主窗口”中的区域设置...</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>每个轴点的坐标数：</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>确定允许的数字格式的区域设置。这由设置/主窗口设置。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>更改轴点后显示轴检查器的秒数</translation>
    </message>
    <message>
...
Every curve name must be unique</source>
        <translation>在曲线列表中添加新曲线。可以在曲线名称列表中编辑曲线名称。每条曲线名称必须是唯一的</translation>
    </message>
    <message>
...
There must always be at least one curve</source>
        <translation>从曲线列表中删除当前选定的曲线。必须始终至少有一条曲线</translation>
    </message>
    <message>
...
Reorder curves by dragging them around.</source>
        <translation>属于此文档的曲线列表。单击曲线名称进行编辑。每个曲线名称必须是唯一的。通过拖动它们来重新排列曲线。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>保存曲线名称以用作将来图形曲线的默认值。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>删除此曲线也将删除</translation>
    </message>
    <message>
...
This applies only to graph curves. No lines are ever drawn between axis points.</source>
        <translation>选择用直线连接点的规则。如果曲线连接为单值函数，则通过增加自变量的值来排序点。如果曲线连接为闭合轮廓，则点为按年龄排序，除了沿现有线放置的点数。放置在任何现有线顶部的任何点都插入到该线的两个端点之间 - 就好像它的年龄介于两个端点的年龄之间。在连续排序的点之间绘制线。直线绘制直线曲线连续点之间的线。使用（x，y）对的自然三次样条与标量序数（t）值相比，在连续点之间使用平滑线绘制平滑曲线。这仅适用于图形曲线。轴点之间不会绘制任何线条。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>选择点的半径（以像素为单位）</translation>
    </message>
    <message>
...
The order of the curves here does not affect the order in the exported file. That order is determined by the Curves settings.</source>
    ...
    <message>
        ...
        <translation>启用或禁用每条曲线端点之外的外推。如果禁用，则仅导出每条曲线的端点之间的点</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>以自动选择的均匀间隔X值插值Y.</translation>
    </message>
    <message>
...
Graph units are preferred when the spacing is to depend on the X scale.</source>
    ...
    <message>
        ...
        <translation>警告间隔太小。在主窗口设置中调整间隔或增加点数限制</translation>
    </message>
    <message>
        ...
        <translation>在网格线上以均匀间隔的X值插值Ys</translation>
    </message>
    <message>
        ...
        <translation>导出的文件将在垂直网格线处具有均匀间隔的X值的值。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>加载默认设置。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>选择网格显示线的宽度。</translation>
    </message>
    <message>
...
设置可以从场景边缘拖动并用于对齐点的辅助线的颜色</translation>
    ...
    <message>
        ...
        <translation>预览窗口，显示当前设置如何影响活动准则。</translation>
    </message>
    <message>
        ...
        <translation>预览窗口，显示当前设置如何影响无效指南。</translation>
    </message>
</context>
<context>
...
Select the initial zoom factor when a new document is loaded. Either the previous zoom can be kept, or the specified zoom can be applied.</source>
    ...
    <message>
        ...
        <translation>保留以前的视图</translation>
    </message>
    <message>
        <location filename="../src/Dlg/DlgSettingsMainWindow.cpp" line="109"/>
...
The locale determines how numbers are formatted. Specifically, either commas or periods will be used as group delimiters in each number entered by the user, displayed in the user interface, or exported to a file.</source>
    ...
    <message>
        <location filename="../src/Dlg/DlgSettingsMainWindow.cpp" line="149"/>
...
选择加载文档后要显示的视图集。既可以保留现有视图，也可以恢复上次用于加载文档的视图。</translation>
    ...
    <message>
        ...
        <translation>使用文档视图</translation>
    </message>
    <message>
        <location filename="../src/Dlg/DlgSettingsMainWindow.cpp" line="123"/>
        <source>Number and date format locale</source>
        <translation>数字和日期格式地区</translation>
    </message>
    <message>
        <location filename="../src/Dlg/DlgSettingsMainWindow.cpp" line="127"/>
        <source>Number and Date Format Locale

Select the locale used to read, display and export numbers and dates. Interface language is selected from Help / Language.

The locale determines how numbers are formatted. Specifically, either commas or periods will be used as group delimiters in each number entered by the user, displayed in the user interface, or exported to a file.</source>
        <translation>数字和日期格式地区

选择读取、显示和导出数字及日期时使用的地区格式。界面语言请在“帮助 / 语言”中选择。

地区格式决定数字的显示方式。具体而言，它会决定用户输入、界面显示或导出文件中的数字使用逗号还是句点作为分组分隔符。</translation>
    </message>
    <message>
        <location filename="../src/Dlg/DlgSettingsMainWindow.cpp" line="162"/>
...
Maximum number of grid lines to be processed. This limit is applied when the step value is too small for the start and stop values, which would result in too many grid lines visually and possibly extremely long processing time (since each grid line would have to be processed)</source>
    ...
    <message>
        ...
        <translation>每条曲线的最大导出点</translation>
    </message>
    <message>
...
This is the maximum number of points allowed in each exported curve. No points are exported when this is exceeded. This limit prevents delays and overly large file sizes due to curves that have too many points.</source>
        <translation>每条曲线的最大导出点

这是每个导出曲线中允许的最大点数。超出此限制时，不会导出任何点。此限制可防止由于曲线具有太多点而导致的延迟和过大的文件大小。</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="../src/Dlg/DlgSettingsMainWindow.cpp" line="212"/>
...
Allows settings dialogs to be made very small so they fit on small computer screens.</source>
    ...
    <message>
        <location filename="../src/Dlg/DlgSettingsMainWindow.cpp" line="249"/>
        <source>Allow drag and drop export</source>
        <translation>允许拖放导出：</translation>
    </message>
    <message>
        <location filename="../src/Dlg/DlgSettingsMainWindow.cpp" line="254"/>
...
When drag and drop is disabled, a rectangular set of table cells can be selected using click and drag. When drag and drop is enabled, a rectangular set of table cells can be selected using Click then Shift+Click, since click and drag starts the drag operation.</source>
    ...
    <message>
        <location filename="../src/Dlg/DlgSettingsMainWindow.cpp" line="262"/>
        <source>Image replace renames document</source>
        <translation> 图像替换重命名文档</translation>
    </message>
    <message>
        <location filename="../src/Dlg/DlgSettingsMainWindow.cpp" line="267"/>
...
When an image is imported to replace the current image, the document will be renamed if this is true, otherwise the name will stay the same.</source>
        <translation>图像替换重命名文档

导入图像以替换当前图像时，如果为真，则将重命名文档，否则名称将保持不变。</translation>
    </message>
    <message>
        <location filename="../src/Dlg/DlgSettingsMainWindow.cpp" line="273"/>
        <source>Significant digits</source>
        <translation>重要数字：</translation>
    </message>
    <message>
        <location filename="../src/Dlg/DlgSettingsMainWindow.cpp" line="278"/>
...
In addition to the points placed at regular intervals, this option causes a point to be placed at each corner. This option can capture important information in piecewise linear graphs, but gradually curving graphs may not benefit from the additional points</source>
    ...
    <message>
        ...
        <translation>将鼠标悬停在线段上时，为沿线段绘制的线选择尺寸</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>不悬停在线段上时，为沿线段绘制的线选择尺寸</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>无效的不透明度</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>对于光标下方的线段，此预览窗口显示可被线段填充的最短线，以及当前设置对线段和由线段填充生成的点的影响</translation>
    </message>
    <message>
...
If drag-and-drop is disabled, a rectangular set of cells may be selected by clicking and dragging. Otherwise, if drag-and-drop is enabled, a rectangular set of cells may be selected using Click then Shift+Click, since click and drag starts the dragging operation. Drag-and-drop mode is set in the Main Window settings</source>
    ...
    <message>
        ...
        <translation>由于重叠，突出显示的段在导出时可能具有意外值。调整点或更改设置/曲线属性/连接为。</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>函数当前具有一个X值的多个Y值。请调整附近的点，或更改曲线属性中的曲线类型</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>无法读取视图加载设置</translation>
    </message>
</context>
<context>
    <name>StatusBar</name>
