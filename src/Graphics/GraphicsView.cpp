  ...
  QGraphicsView (scene)
{
  ...
  setWhatsThis (tr ("Main Window\n\n"
                    ...
                    "If the image is a graph with two axes and one or more curves, choose three or four axis points "
                    "during import. In three-point mode, place three widely separated points whose two coordinates are "
                    "known. In four-point mode, place two widely separated points on each axis and enter the requested "
                    "axis coordinate. Then curve points can be added along the curves.\n\n"
